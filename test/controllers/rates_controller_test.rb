...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference("Rate.count") do
      post rates_url, params: { rate: { maxAge: @rate.maxAge, minAge: @rate.minAge, rate: @rate.rate } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { maxAge: @rate.maxAge, minAge: @rate.minAge, rate: @rate.rate } }
