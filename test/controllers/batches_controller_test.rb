...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference("Batch.count") do
      post batches_url, params: { batch: { description: @batch.description, name: @batch.name, product_id: @batch.product_id } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { description: @batch.description, name: @batch.name, product_id: @batch.product_id } }
