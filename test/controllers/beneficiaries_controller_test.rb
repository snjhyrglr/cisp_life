...
class BeneficiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beneficiary" do
    assert_difference("Beneficiary.count") do
      post beneficiaries_url, params: { beneficiary: { I_R: @beneficiary.I_R, age: @beneficiary.age, member_id: @beneficiary.member_id, name: @beneficiary.name, relationship: @beneficiary.relationship } }
    end
  ...
  test "should update beneficiary" do
    patch beneficiary_url(@beneficiary), params: { beneficiary: { I_R: @beneficiary.I_R, age: @beneficiary.age, member_id: @beneficiary.member_id, name: @beneficiary.name, relationship: @beneficiary.relationship } }
