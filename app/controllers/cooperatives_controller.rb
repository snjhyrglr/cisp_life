class CooperativesController < ApplicationController
  ...
  def index
    ...
    @cooperatives = Cooperative.paginate(page: params[:page], per_page: 10)
  end
  ...
  def import 
    Cooperative.import(params[:file])
  ...
  private
    ...
    def cooperative_params
      params.require(:cooperative).permit(:name, :address, :abbreviation)
    end
end
